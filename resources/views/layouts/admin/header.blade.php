<header class="navbar navbar-expand-md navbar-light d-none d-lg-flex d-print-none">
  <div class="container-xl">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pembaruan</h3>
              </div>
                ...
                <div class="list-group-item">
                  <div class="row align-items-center">
                    ...
                    <div class="col text-truncate">
                      <a href="#" class="text-body d-block">Siswa Absen</a>
                      <div class="d-block text-muted text-truncate mt-n1">Zakian Telah Absen....</div>
                    </div>
                    <div class="col-auto">
                      <a href="#" class="list-group-item-actions" title="Tandai sebagai favorit">
      ...
      <div class="nav-item dropdown">
        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Buka menu pengguna">
          ...
          <div class="d-none d-xl-block ps-2">
            <div>{{ Auth::guard('user')->user()->name ?? 'Nama Pengguna' }}</div> 
    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div>
        <form action="./dashboardadmin" method="get" autocomplete="off" novalidate>
          <div class="input-icon">
            <span class="input-icon-addon">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>
            </span>
            <input type="text" class="form-control" placeholder="Cari..." aria-label="Cari di website">
          </div>
        </form>
      </div>
    </div>
